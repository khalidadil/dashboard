...
export default React.createClass({
  ...
  propTypes: {
    leftSidebarState: React.PropTypes.bool,
  },

  renderSidebarButtons() { 
    const leftSidebarState = this.props.leftSidebarState ? 'page-sidebar-menu-closed' : '';
    return (
      <ul className={`page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu ${leftSidebarState}`} data-keep-expanded="false" data-auto-scroll="true" data-slide-speed={200}>
